...
uploaded_file = st.file_uploader("Upload a CSV file with patent numbers. To create a CSV file: Open a plain text editor (e.g., Editor or TextEdit).Enter the patent numbers into the text editor. Make sure each patent number is on a separate line.Save the file with a .csv extension, e.g., input_patents.csv.", type="csv")
